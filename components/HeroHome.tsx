      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div className="mb-8 animate-float">
            <Cloud id="logo-cloud" style={{ transform: "rotate(90deg)" }} className="h-24 w-24 text-white mx-auto mb-6 drop-shadow-lg" />
          </div>
          
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 animate-fade-in drop-shadow-md">
            <span className="text-light-blue-200">Tu </span>idea,<br/><span className="text-light-blue-200">nuestra </span>solución
          </h1>
          ...
          <p className="text-lg text-light-blue-100 mb-12 max-w-2xl mx-auto animate-fade-in drop-shadow-sm" style={{ animationDelay: '0.4s' }}>
            Desarrollo web, E-commerce, IA, diseño y consultoría para Pymes y emprendedores.
          </p>
