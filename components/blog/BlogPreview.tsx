...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      'Técnicas probadas para mejorar el posicionamiento de tu sitio web en los motores de búsqueda.',
  ...
  },
  {
    ...
    excerpt:
      'Ejemplos reales de cómo la inteligencia artificial puede automatizar procesos empresariales.',
    category: 'Inteligencia Artificial',
    author: {
      name: 'María González',
      role: 'Especialista en IA',
  ...
  },
  {
    ...
    excerpt:
      'Cómo desarrollar una marca digital coherente que conecte con tu audiencia objetivo.',
    category: 'Diseño',
    author: {
      name: 'Carlos Mendoza',
      role: 'Designer Senior',
    ...
    readTime: '5 min',
    image:
      'https://images.unsplash.com/photo-1493421419110-74f4e85ba126?w=400&h=200&fit=crop',
  },
];
