      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 leading-relaxed">
            ...
            diseño. Nos especializamos en crear soluciones digitales que
            impulsan el crecimiento de nuestros clientes en la era digital.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Democratizar el acceso a tecnologías avanzadas y diseño de
                calidad
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Ser referentes en innovación digital y transformación
                tecnológica
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Innovación, calidad, transparencia y compromiso con el éxito del
                cliente
              </p>
            </div>
          </div>
